...
function getDataAgain() {
    $.ajax({
        ...
        success: function(result) {
            if (updatedTime != result.updateTime) {
                areaArray = [];
                apArray = [];
                ...
                updatedTime = result.updateTime;
                mainPos = new google.maps.LatLng(result.mainPos.Lat, result.mainPos.Lng);
                mainZoom = result.mainZoom;
                mapType = result.mapType;
                mapRadius = result.mapRadius;
                $.each(result.heatData, function(i, obj) {
